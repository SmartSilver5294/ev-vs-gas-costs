...
Have you ever wondered whether an EV or a gas car would be better for you? I’ve been exploring the best states to buy an EV in, and comparing different EVs with their gas counterparts using a data set from [AAA](https://gasprices.aaa.com/ev-charging-prices/). Today, I have compiled the data into multiple interactive graphs
that lets you visualize EV costs over a span of 3 years compared to gas costs over the same time frame. I also made multiple other graphs and tables that demonstrate the key takeaways and comparisons of specific cars. I have found that the best EV model compared to its gas counterpart is the Honda Prologue, and the best states to buy an EV in are Washington and California. Feel free to look around and enjoy the website!